...
export const MOCKUP_SCENES = [
  ...
  // ── Dining room (2)
  {
    ...
    prompt:
      ...
      'a low ceramic bowl with a few short-stemmed wildflowers. No pendant or ceiling light in view. ' +
      'Wide composition; the wall behind the table is matte clay-beige plaster, broad and completely empty.',
  },
  {
  ...
  cityScene({
    ...
    code: 'BAL',
    desc:
      'A Balinese pavilion bedroom: low teak bed with simple white bedding (no canopy, no net), ' +
      'rattan bench at its foot, limewashed walls, teak floor, woven pandan rug. ' +
      'The broad limewashed wall behind the bed is completely bare.',
  ...
  cityScene({
    ...
    code: 'LA',
    desc:
      'A Los Angeles canyon mid-century living room: tan leather sofa with a wool throw over one arm, ' +
      'walnut coffee table with a stack of art books and a ceramic bowl, large floor plant, ' +
      'low walnut credenza with a sculptural table lamp against a side wall, ' +
      'smooth white plaster walls, warm wood floor, a clerestory window hint above.',
  ...
  cityScene({
    ...
    code: 'MAL',
    desc:
      'An intimate corner of a Mallorcan finca dining room, camera close to the table: ' +
      'rustic table set for four, rush-seat chairs, a ceramic bowl, lime plaster wall ' +
      'directly behind the table filling most of the frame, terracotta floor, ' +
      'a hint of a dark beam at the top edge. No pendant or ceiling light in view.',
  ...
  cityScene({
    ...
    code: 'VEN',
    desc:
      'A Venetian palazzo bedroom: bed with ivory linen, an elegant carved-walnut chair ' +
      'with pristine ivory silk upholstery, pale marmorino plaster walls, terrazzo floor.',
  ...
  cityScene({
    ...
    code: 'VEN',
    desc:
      'A Venetian portego hall: slim console with a Murano glass vase and a brass bowl, ' +
      'a pair of carved antique chairs along the window side, a tall floor vase with dried branches, ' +
      'an aged leather bench, terrazzo floor, aged plaster walls.',
  ...
  cityScene({
    ...
    code: 'ZUR',
    desc:
      'A precise Zurich office: pale oak desk with a black anglepoise lamp, a closed notebook ' +
      'and a neat stack of monographs, black chair, low oak sideboard with two ceramic vessels ' +
      'and a small analog clock along a side wall, wool rug under the desk, ' +
  ...
  cityScene({
    ...
    code: 'MUN',
    desc:
      'A Munich Altbau landing: simple bench with a folded wool blanket and a stack of books, ' +
      'potted fig tree, brass umbrella stand, woven runner on the floor, ' +
      'a stucco edge at the ceiling, oak herringbone floor, matte white walls.',
  ...
  cityScene({
    ...
    code: 'COP',
    desc:
      'A Copenhagen living room: greige wool sofa with a chunky knit throw, round oak coffee table ' +
      'with a ceramic teapot and stacked books, paper pendant lamp, oak side table with unlit candles, ' +
      'floor lamp in the corner, small potted plant, white walls, oak floor.',
  ...
  cityScene({
    ...
    code: 'AUS',
    desc:
      'An Austin barn studio: reclaimed-wood desk with a mug and an open notebook, black steel chair, ' +
      'tan leather butterfly chair, low bookshelf with pottery and books along the shiplap side wall, ' +
      'potted cactus, wool area rug under the desk, vintage steel floor lamp, ' +
